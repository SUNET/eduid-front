...
function happyCaseBackend(state: SignupState) {
  ...
  mswServer.use(
    ...
    http.get("https://signup.eduid.docker/services/signup/state", ({ request }) => {
  ...
  mswServer.use(
    http.post("https://signup.eduid.docker/services/signup/get-captcha", ({ request }) => {
  ...
  mswServer.use(
    http.post("https://signup.eduid.docker/services/signup/get-password", ({ request }) => {
