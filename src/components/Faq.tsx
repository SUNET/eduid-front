  ...
  return (
    <React.Fragment>
      ...
      <ul className="faq-content">
        <li>
          <h3>
            <FormattedMessage description="eduID" defaultMessage="eduID" />
          </h3>
          <h4>
          ...
          <ul className="bullets">
            ...
            <li>
              <FormattedMessage description="Log in at eduid.se when you: list item" defaultMessage="Lose a password" />
            </li>
          </ul>
        ...
        <li>
          <h3>
            <FormattedMessage description="Identity heading" defaultMessage="Identity" />
          </h3>
          <h4>
            <FormattedMessage
        ...
        <li>
          <h3>
            <FormattedMessage description="Freja eID+ heading" defaultMessage="Freja eID+" />
          </h3>
          ...
          <h4>
            <FormattedMessage
              description="How do I find an ATG agent authorised for Freja eID+? heading"
              defaultMessage="How do I find an ATG agent authorised for Freja eID+?"
            />
          </h4>
          <p>
            <FormattedMessage
              description="The nearest authorised ATG agents can be found in the app."
              defaultMessage="The nearest authorised ATG agents can be found in the app."
            />
          </p>
        ...
        <li>
          <h3>
            <FormattedMessage description="SUNET" defaultMessage="SUNET" />
          </h3>
          <h4>
        ...
        <li>
          <h3>
            <FormattedMessage description="ORCID heading" defaultMessage="ORCID" />
          </h3>
          <h4>
        ...
        <li>
          <h3>
            <FormattedMessage description="Privacy policy heading" defaultMessage="Privacy policy" />
          </h3>
          <h4>
            <FormattedMessage
              description=" What is the eduID privacy policy? heading"
        ...
        <li>
          <h3>
            <FormattedMessage description="Contact heading" defaultMessage="Contact" />
          </h3>
          <h4>
            <FormattedMessage
          ...
          <ul className="bullets">
            <li>
              <FormattedMessage
                ...
                defaultMessage="Monday to Thursday 09:00-12:00, 13:00-16:00"
              />
            </li>
            <li>
              <FormattedMessage
