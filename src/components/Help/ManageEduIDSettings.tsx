      ...
      <article>
        ...
        <Accordion id="eduid-settings">
          ...
          >
            ...
            <ul className="bullets">
              ...
              <li>
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.start31"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.start32"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.start33"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.start34"
            ...
            <p>
              <FormattedMessage
                id="manageEduIDSettings.statusNote"
          ...
          >
            <p>
              <FormattedMessage
                id="manageEduIDSettings.identity"
            ...
            <ul className="bullets">
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.identity1"
              ...
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.identity2"
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.identity21"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.identity22"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.identity23"
                ...
                <p>
                  <FormattedMessage
                    id="manageEduIDSettings.methodsNote"
                    description="start eduid - paragraph"
              ...
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.identity3"
          ...
          >
            <p>
              <FormattedMessage
                id="manageEduIDSettings.security"
            ...
            <ul className="bullets">
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.security1"
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security11"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security12"
              ...
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.security2"
              ...
              <li>
                <FormattedMessage
                  id="manageEduIDSettings.security3"
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security30"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security31"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security32"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security33"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.security34"
            ...
            <p>
              <FormattedMessage
                id="manageEduIDSettings.securityParagraph"
          ...
          >
            <p>
              <FormattedMessage
                id="manageEduIDSettings.account"
            ...
            <ul className="bullets">
              <li>
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account0"
              ...
              <li>
                <strong>
                  <FormattedMessage
                    id="manageEduIDSettings.heading1"
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account1"
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account11"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account12"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account13"
              ...
              <li>
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account2"
              ...
              <li>
                <strong>
                  <FormattedMessage
                    id="manageEduIDSettings.heading3"
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account3"
                ...
                <ul className="nested">
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account31"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account32"
                  ...
                  <li>
                    <FormattedMessage
                      id="manageEduIDSettings.account33"
              ...
              <li>
                <strong>
                  <FormattedMessage
                    id="manageEduIDSettings.heading4"
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account4"
              ...
              <li>
                <strong>
                  <FormattedMessage
                    id="manageEduIDSettings.heading5"
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account5"
              ...
              <li>
                <strong>
                  <FormattedMessage
                    id="manageEduIDSettings.heading6"
                ...
                &nbsp;
                <FormattedMessage
                  id="manageEduIDSettings.account6"
            ...
            <p>
              <FormattedMessage
                id="manageEduIDSettings.paragraph"
        ...
        <h4>
          <FormattedMessage
            id="manageEduIDSettings.deleteHeading"
        ...
        <p>
          <FormattedMessage
            id="manageEduIDSettings.deleteParagraph"
