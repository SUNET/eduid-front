...
const SIGNUP_LABELS = [
  <FormattedMessage id="stepIndicator.step1" key="step1" description="signup step1" defaultMessage="Registration method" />,
  <FormattedMessage id="stepIndicator.step2" key="step2" description="signup step2" defaultMessage="Confirm/Accept" />,
  <FormattedMessage id="common.verifyEmailAddress" key="step3" description="signup step3" defaultMessage="Verify email address" />,
