...
const RESETPW_LABELS = [
  <FormattedMessage key="step1" description="resetpw step1" defaultMessage="Enter email address" />,
  <FormattedMessage key="step2" description="resetpw step2" defaultMessage="Confirm Captcha" />,
  ...
  <FormattedMessage key="step5" description="resetpw step5" defaultMessage="Set password" />,
