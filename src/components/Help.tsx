              ...
              <section>
                ...
                <p>
                  ...
                  <FormattedMessage
                    ...
                    values={{
                      FrejaProtectedId: (
                        <EduIDLink to={FrejaProtectedIdURL}>
                          <FormattedMessage
            ...
            <article>
              ...
              <p>
                <FormattedMessage
                  ...
                  values={{
                    support: <EduIDLink to="mailto:support@eduid.se">support@eduid.se</EduIDLink>,
                  }}
                />
              </p>
              <ul className="bullets">
              ...
              <p>
                ...
                />
                &nbsp;
                <EduIDLink to="tel:+468-55521362">08-555 213 62</EduIDLink>
              </p>
              <p>
