  ...
  return (
    <React.Fragment>
      ...
      <div className="faq-content">
        <Accordion allowMultipleExpanded allowZeroExpanded id="Getting started">
          <AccordionItemTemplate
            uuid="help-getting-started-1"
            title={<FormattedMessage description="Getting started" defaultMessage="Getting started" />}
            additionalInfo={null}
          >
            <h3>
        ...
        <Accordion allowMultipleExpanded allowZeroExpanded id="Frequently asked questions">
          <AccordionItemTemplate
            uuid="help-Frequently-asked-questions-1"
            title={
              <FormattedMessage description="Frequently asked questions" defaultMessage="Frequently asked questions" />
            }
            additionalInfo={null}
          >
            <h3>
        ...
        <Accordion allowMultipleExpanded allowZeroExpanded id="Privacy Policy">
          <AccordionItemTemplate
            ...
            title={<FormattedMessage description="Privacy policy heading" defaultMessage="Privacy policy" />}
            additionalInfo={null}
          >
            <h3>
              <FormattedMessage
        ...
        <Accordion allowMultipleExpanded allowZeroExpanded id="Web Accessibility">
          <AccordionItemTemplate
            ...
            title={<FormattedMessage description="Web Accessibility heading" defaultMessage="Web Accessibility" />}
            additionalInfo={null}
          >
            <h3>
              <FormattedMessage
                description=" What is the eduID Web Accessibility? heading"
        ...
        <Accordion allowMultipleExpanded allowZeroExpanded id="Contact us">
          <AccordionItemTemplate
