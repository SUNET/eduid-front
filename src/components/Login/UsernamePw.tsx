    ...
    <React.Fragment>
      ...
      <section className="username-pw-option">
        <div className="or-container">
          ...
          <span>
            <FormattedMessage defaultMessage="Other login options" description="Alternative login option" />
          </span>
          <div className="line"></div>
        </div>
...
export function UsernamePwSubmitButton(props: FormRenderProps<UsernamePwFormData>): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <FormattedMessage defaultMessage="log in" description="Login front page with pw" />
    </EduIDButton>
  );
}
