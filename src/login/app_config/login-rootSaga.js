...
import { postSetNewPasswordSaga } from "../redux/sagas/resetpassword/postSetNewPasswordSaga";
...
function* rootSaga() {
  yield [
    ...
    takeLatest(postResetPasswordActions.POST_RESET_PASSWORD_NEW_PASSWORD, postSetNewPasswordSaga),
  ];
}
