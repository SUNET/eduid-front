...
export const POST_SECURITY_REFRESH_OFFICIAL_USER_DATA_SUCCESS = "POST_SECURITY_REFRESH_OFFICIAL_USER_DATA_SUCCESS";
export const POST_SECURITY_REFRESH_OFFICIAL_USER_DATA_FAIL = "POST_SECURITY_REFRESH_OFFICIAL_USER_DATA_FAIL";
