...
export const resetPasswordSagaFail = createAction(
...
export const requestPhoneCode = createAction(
  "requestPhoneCode",
...
export const savePhoneCode = createAction(
  "savePhoneCode",
...
export const storeNewPassword = createAction(
  "storeNewPassword",
  function prepare(newPassword) {
    return {
      payload: {
...
export const setNewPasswordExtraSecurityPhone = createAction(
...
export const setNewPasswordExtraSecurityToken = createAction(
...
export const setNewPasswordExtraSecurityExternalMfa = createAction(
