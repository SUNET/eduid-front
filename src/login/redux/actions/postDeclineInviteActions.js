...
export const POST_GROUP_INVITE_INVITES_DECLINE_SUCCESS =
  "POST_GROUP_INVITE_INVITES_DECLINE_SUCCESS";
export const POST_GROUP_INVITE_INVITES_DECLINE_FAIL =
  "POST_GROUP_INVITE_INVITES_DECLINE_FAIL";
