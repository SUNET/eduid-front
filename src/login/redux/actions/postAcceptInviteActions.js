...
export const POST_GROUP_INVITE_INVITES_ACCEPT_SUCCESS =
  "POST_GROUP_INVITE_INVITES_ACCEPT_SUCCESS";
export const POST_GROUP_INVITE_INVITES_ACCEPT_FAIL =
  "POST_GROUP_INVITE_INVITES_ACCEPT_FAIL";
