...
export const POST_GROUP_MANAGEMENT_DELETE_SUCCESS = "POST_GROUP_MANAGEMENT_DELETE_SUCCESS";
export const POST_GROUP_MANAGEMENT_DELETE_FAIL = "POST_GROUP_MANAGEMENT_DELETE_FAIL";
