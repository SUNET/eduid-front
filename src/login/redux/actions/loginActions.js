...
export const loginSagaFail = createAction('LOGIN_SAGA_FAIL', function prepare(err) {
   return {
     error: true,
     payload: {
...
export const postUsernamePassword = createAction('postUsernamePassword', function prepare(username, password) {
  return {
    payload: {
      username: username,
      password: password,
...
export const postRefForWebauthnChallenge = createAction("postRefForWebauthnChallenge");
