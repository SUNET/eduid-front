...
export const POST_GROUP_INVITE_INVITES_CREATE_SUCCESS = "POST_GROUP_INVITE_INVITES_CREATE_SUCCESS";
export const POST_GROUP_INVITE_INVITES_CREATE_FAIL = "POST_GROUP_INVITE_INVITES_CREATE_FAIL";
